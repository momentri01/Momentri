    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {user?.role === 'ORGANIZATION' ? (
        <div className="text-center py-24 bg-white rounded-3xl border shadow-sm">
           <h1 className="text-3xl font-black mb-4">Organization Portal</h1>
           <p className="text-muted-foreground mb-8">Welcome back. Your tools are currently under development.</p>
        </div>
      ) : (
        <>
